...
:HTML_CONTAINER_CLASS: badge
:END:
- Using the connectors as beams, your finger as the effort and an elastic band as the resistance, build all three classes of lever, take a photo of your *second class* lever and upload to www.bournetolearn.com.
** Learn It
:PROPERTIES:
:HTML_CONTAINER_CLASS: learn
:END:
